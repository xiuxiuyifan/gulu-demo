<template>
  <div class="demo" id="app">
    ...
    <g-checkbox :check-all-animation="checkAllAnimation" :use-checked="checkAll" @change="checkBoxAll">全选
    </g-checkbox>
  ...
  export default {
    ...
    methods: {
      ...
      onChange (checkedList) {
        ...
        //在这里判断子节点是否都选中了=
        if (checkedList.length === this.plainOption.length) {
          this.checkAllAnimation = false
          this.checkAll = true
